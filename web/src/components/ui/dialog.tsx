...
const DialogHeader = ({
  ...
  <div className="sticky z-40 top-0 flex items-center gap-2 border-b bg-background">
    <div
      className={cn(
    ...
    <DialogClose asChild>
      <button
        className="absolute top-4 right-4 p-2 rounded-full bg-background/95"
        aria-label="Close"
      >
